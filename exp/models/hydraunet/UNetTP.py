...
class UNet3Plus(nn.Module):
    def __init__(self, cfg, n_channels=None, n_classes=None, enable_outc=True):
        ...
        self.e4_d3 = conv_block(self.reduction_channels, self.reduction_channels)
        ...
        self.e3_d2 = conv_block(self.reduction_channels, self.reduction_channels)
        self.e4_d2 = conv_block(self.reduction_channels, self.reduction_channels)
        ...
        self.e2_d1 = conv_block(self.reduction_channels, self.reduction_channels)
        self.e3_d1 = conv_block(self.reduction_channels, self.reduction_channels)
        self.e4_d1 = conv_block(self.reduction_channels, self.reduction_channels)
